...
> **18 problems** — **Graphs** reduce to choosing the right traversal: BFS for shortest path (unweighted), DFS for connectivity/topological sort, Dijkstra for weighted shortest paths.
...
| 7 | [Cheapest Flight With K Stops](#cheapestflightwithkstops) |
| 8 | [Node](#clonegraph) |
| 9 | [Course Schedule](#courseschedule) |
| 10 | [Course Schedule_II](#courseschedule_ii) |
| 11 | [Course Schedule_II_BFS](#courseschedule_ii_bfs) |
| 12 | [Critical Connections In A Network](#criticalconnectionsinanetwork) |
| 13 | [Critical Connections In A Network Short Code](#criticalconnectionsinanetworkshortcode) |
| 14 | [Find Redundent Connections](#findredundentconnections) |
| 15 | [Tree Node](#houserobber3) |
| 16 | [Parallel Courses](#parallelcourses) |
| 17 | [Reorder Routes To Make All Paths Lead To City Zero](#reorderroutestomakeallpathsleadtocityzero) |
| 18 | [Word Ladder](#wordladder) |
